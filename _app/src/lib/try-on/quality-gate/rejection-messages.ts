...
export const REJECTION_MESSAGES: Record<RejectionReason, RejectionMessage> = {
  no_person: {
    ...
    ptBr: 'Não conseguimos encontrar você nesta foto. Por favor, envie uma foto onde você apareça com clareza.',
  },
  multiple_people: {
    key: 'multiple_people',
    ...
    ptBr: 'Sua foto mostra mais de uma pessoa. Por favor, envie uma foto em que apenas você apareça.',
  },
  too_blurry: {
    key: 'too_blurry',
    ...
    ptBr: 'Esta foto está um pouco desfocada. Envie uma foto mais nítida para um resultado melhor no Provador Virtual.',
  },
  bad_lighting: {
    key: 'bad_lighting',
    ...
    ptBr: 'A iluminação desta foto está difícil. Envie uma foto com luz mais uniforme.',
  },
  partial_body: {
    key: 'partial_body',
    ...
    ptBr: 'Só conseguimos ver parte do seu corpo. Envie uma foto de corpo inteiro, da cabeça aos pés.',
  },
  selfie_for_bottom: {
    ...
    ptBr: 'Para experimentar esta peça, precisamos ver seu corpo inteiro. Envie uma foto que inclua suas pernas.',
  },
  selfie_for_top_cropped: {
    ...
    ptBr: 'Envie uma foto que mostre seu rosto e a parte de cima do corpo para um resultado melhor.',
  },
  no_face: {
    key: 'no_face',
    ...
    ptBr: 'Precisamos ver seu rosto para preservar o seu visual no Provador Virtual. Envie uma foto com o rosto visível.',
  },
  low_resolution: {
    key: 'low_resolution',
    ...
    ptBr: 'Esta foto está pequena. Envie uma foto maior ou mais nítida para um resultado melhor.',
  },
  target_region_occluded: {
    ...
    ptBr: 'Algo está cobrindo a área onde a peça apareceria. Envie uma foto em que essa área esteja bem visível.',
  },
  garment_unclear: {
    key: 'garment_unclear',
    ...
    ptBr: 'Não conseguimos ler a foto da peça com clareza. Verifique se ela aparece inteira e centralizada.',
  },
  pose_mismatch: {
    key: 'pose_mismatch',
    ...
    ptBr: 'Envie uma foto em pé para que a peça caia corretamente no Provador Virtual.',
  },
  uncertain: {
    key: 'uncertain',
    ...
    ptBr: 'A foto não está muito visível para garantir a melhor qualidade. Quer enviar outra foto ou continuar mesmo assim?',
  },
}
